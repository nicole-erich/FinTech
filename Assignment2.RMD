...
exp.module(C2,N2,e2) # test message2, should equal M2
...
exp.module(C3,N3,e3) # test message3, should equal M3
...
The number $x$ attatched to "2017" such that after the transformation with the Hash function the output starts with at least three 0's (zeros) is $x =$ `r x`.  The hashed string is `r str.Hashed`, which starts with three 0's (zeros).
